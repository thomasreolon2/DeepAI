...
Blockly.Dart.lists_create_with = function (a) {
  for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++)
    b[c] =
      Blockly.Dart.valueToCode(a, "ADD" + c, Blockly.Dart.ORDER_NONE) || "null";
...
Blockly.Dart.lists_getIndex = function (a) {
  ...
  if ((("RANDOM" != d || "REMOVE" != c) && "FROM_END" != d) || e.match(/^\w+$/))
    switch (d) {
      case "FIRST":
      ...
      case "FROM_START":
        ...
        if ("GET_REMOVE" == c)
          return [e + ".removeAt(" + d + ")", Blockly.Dart.ORDER_UNARY_POSTFIX];
...
Blockly.Dart.lists_setIndex = function (a) {
  ...
  switch (d) {
    ...
    case "FROM_END":
      ...
      if ("INSERT" == c)
        return a + (e + ".insert(" + e + ".length - " + d + ", " + f + ");\n");
      break;
    case "RANDOM":
      Blockly.Dart.definitions_.import_dart_math =
        "import 'dart:math' as Math;";
...
Blockly.Dart.controls_if = function (a) {
  ...
  do {
    var d =
      Blockly.Dart.valueToCode(a, "IF" + b, Blockly.Dart.ORDER_NONE) || "false";
...
Blockly.Dart.controls_for = function (a) {
  var b = Blockly.Dart.variableDB_.getName(
    ...
    c =
      Blockly.Dart.valueToCode(a, "FROM", Blockly.Dart.ORDER_ASSIGNMENT) || "0",
...
Blockly.Dart.math_number = function (a) {
  ...
  if (Infinity == a) {
    ...
    -Infinity == a
      ...
      : (b =
          0 > a ? Blockly.Dart.ORDER_UNARY_PREFIX : Blockly.Dart.ORDER_ATOMIC);
  return [a, b];
};
...
Blockly.Dart.math_single = function (a) {
  ...
  a =
    "ABS" == b || "ROUND" == b.substring(0, 5)
      ? Blockly.Dart.valueToCode(a, "NUM", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
        "0"
      : "SIN" == b || "COS" == b || "TAN" == b
      ? Blockly.Dart.valueToCode(a, "NUM", Blockly.Dart.ORDER_MULTIPLICATIVE) ||
        "0"
      : Blockly.Dart.valueToCode(a, "NUM", Blockly.Dart.ORDER_NONE) || "0";
  switch (b) {
    case "ABS":
...
Blockly.Dart.math_modulo = function (a) {
  ...
  a =
    Blockly.Dart.valueToCode(a, "DIVISOR", Blockly.Dart.ORDER_MULTIPLICATIVE) ||
    "0";
...
Blockly.Dart.procedures_defreturn = function (a) {
  ...
  for (
    var l = f ? "dynamic" : "void", k = [], h = 0;
    h < a.arguments_.length;
    h++
  )
...
Blockly.Dart.procedures_callreturn = function (a) {
  for (
    ...
    c[d] =
      Blockly.Dart.valueToCode(a, "ARG" + d, Blockly.Dart.ORDER_NONE) || "null";
...
Blockly.Dart.text_getSubstring = function (a) {
  var b =
      Blockly.Dart.valueToCode(a, "STRING", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
      "''",
    c = a.getFieldValue("WHERE1"),
    d = a.getFieldValue("WHERE2");
...
Blockly.Dart.variables_set = function (a) {
  var b =
    Blockly.Dart.valueToCode(a, "VALUE", Blockly.Dart.ORDER_ASSIGNMENT) || "0";
  return (
    Blockly.Dart.variableDB_.getName(
      a.getFieldValue("VAR"),
      Blockly.VARIABLE_CATEGORY_NAME
