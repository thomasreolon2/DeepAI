...
Blockly
    .PHP
    .addReservedWords(
        "__halt_compiler,abstract,and,array,as,break,callable,case,catch,class,clone,co" +
        "nst,continue,declare,default,die,do,echo,else,elseif,empty,enddeclare,endfor,e" +
        "ndforeach,endif,endswitch,endwhile,eval,exit,extends,final,for,foreach,functio" +
        "n,global,goto,if,implements,include,include_once,instanceof,insteadof,interfac" +
        "e,isset,list,namespace,new,or,print,private,protected,public,require,require_o" +
        "nce,return,static,switch,throw,trait,try,unset,use,var,while,xor,PHP_VERSION,P" +
        "HP_MAJOR_VERSION,PHP_MINOR_VERSION,PHP_RELEASE_VERSION,PHP_VERSION_ID,PHP_EXTR" +
        "A_VERSION,PHP_ZTS,PHP_DEBUG,PHP_MAXPATHLEN,PHP_OS,PHP_SAPI,PHP_EOL,PHP_INT_MAX" +
        ",PHP_INT_SIZE,DEFAULT_INCLUDE_PATH,PEAR_INSTALL_DIR,PEAR_EXTENSION_DIR,PHP_EXT" +
        "ENSION_DIR,PHP_PREFIX,PHP_BINDIR,PHP_BINARY,PHP_MANDIR,PHP_LIBDIR,PHP_DATADIR," +
        "PHP_SYSCONFDIR,PHP_LOCALSTATEDIR,PHP_CONFIG_FILE_PATH,PHP_CONFIG_FILE_SCAN_DIR" +
        ",PHP_SHLIB_SUFFIX,E_ERROR,E_WARNING,E_PARSE,E_NOTICE,E_CORE_ERROR,E_CORE_WARNI" +
        "NG,E_COMPILE_ERROR,E_COMPILE_WARNING,E_USER_ERROR,E_USER_WARNING,E_USER_NOTICE" +
        ",E_DEPRECATED,E_USER_DEPRECATED,E_ALL,E_STRICT,__COMPILER_HALT_OFFSET__,TRUE,F" +
        "ALSE,NULL,__CLASS__,__DIR__,__FILE__,__FUNCTION__,__LINE__,__METHOD__,__NAMESP" +
        "ACE__,__TRAIT__"
    );
...
Blockly.PHP.init = function (a) {
    ...
    Blockly
        .PHP
        .variableDB_
        .setVariableMap(a.getVariableMap());
    for (
        var b = [],
        ...
        b.push(
            Blockly.PHP.variableDB_.getName(c[d], Blockly.Names.DEVELOPER_VARIABLE_TYPE) +
            ";"
        );
    a = Blockly
        .Variables
    ...
    for (d = 0; c = a[d]; d++) 
        b.push(
            Blockly.PHP.variableDB_.getName(c.getId(), Blockly.VARIABLE_CATEGORY_NAME) +
            ";"
        );
...
Blockly.PHP.finish = function (a) {
    var b = [],
        c;
    for (c in Blockly.PHP.definitions_) 
        b.push(Blockly.PHP.definitions_[c]);
...
Blockly.PHP.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
        ...
        for (var f = 0; f < a.inputList.length; f++) 
            a
                .inputList[f]
                .type == Blockly.INPUT_VALUE && (e = a.inputList[f].connection.targetBlock()) && (
...
Blockly.PHP.getAdjusted = function (a, b, c, d, e) {
    ...
    a = 0 < c
        ? Blockly
            .PHP
            .valueToCode(a, b, Blockly.PHP.ORDER_ADDITION) || f
        : 0 > c
            ? Blockly
                .PHP
                .valueToCode(a, b, Blockly.PHP.ORDER_SUBTRACTION) || f
            : d
                ? Blockly
                    .PHP
                    .valueToCode(a, b, Blockly.PHP.ORDER_UNARY_NEGATION) || f
                : Blockly
                    .PHP
                    .valueToCode(a, b, e) || f;
...
Blockly.PHP.colour_random = function (a) {
    return [
        Blockly
            .PHP
            .provideFunction_("colour_random", [
...
Blockly.PHP.colour_rgb = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "RED", Blockly.PHP.ORDER_COMMA) || 0,
        c = Blockly
            .PHP
            .valueToCode(a, "GREEN", Blockly.PHP.ORDER_COMMA) || 0;
    a = Blockly
        .PHP
        .valueToCode(a, "BLUE", Blockly.PHP.ORDER_COMMA) || 0;
    return [
        Blockly
            .PHP
...
Blockly.PHP.colour_blend = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "COLOUR1", Blockly.PHP.ORDER_COMMA) || "'#000000'",
        c = Blockly
            .PHP
            .valueToCode(a, "COLOUR2", Blockly.PHP.ORDER_COMMA) || "'#000000'";
    a = Blockly
        .PHP
        .valueToCode(a, "RATIO", Blockly.PHP.ORDER_COMMA) || .5;
    return [
        Blockly
            .PHP
...
Blockly.PHP.lists_create_with = function (a) {
    for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++) 
        b[c] = Blockly
            .PHP
            .valueToCode(a, "ADD" + c, Blockly.PHP.ORDER_COMMA) || "null";
    b = "array(" + b.join(", ") + ")";
...
Blockly.PHP.lists_repeat = function (a) {
    var b = Blockly
        ...
        c = Blockly
            .PHP
            .valueToCode(a, "ITEM", Blockly.PHP.ORDER_COMMA) || "null";
    a = Blockly
        .PHP
        .valueToCode(a, "NUM", Blockly.PHP.ORDER_COMMA) || "0";
    return [
        b + "(" + c + ", " + a + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
...
Blockly.PHP.lists_length = function (a) {
    ...
    a = Blockly
        .PHP
        .valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "''";
    return [
        b + "(" + a + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
...
Blockly.PHP.lists_isEmpty = function (a) {
    return [
        "empty(" + (
            Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_FUNCTION_CALL) || "array()"
        ) + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
};
Blockly.PHP.lists_indexOf = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "FIND", Blockly.PHP.ORDER_NONE) || "''",
        c = Blockly
            .PHP
            .valueToCode(a, "VALUE", Blockly.PHP.ORDER_MEMBER) || "[]";
    ...
    switch (a.getFieldValue("WHERE") || "FROM_START") {
        case "FIRST":
            if ("GET" == b) {
                var c = Blockly
                    .PHP
                    .valueToCode(a, "VALUE", Blockly.PHP.ORDER_MEMBER) || "array()";
                return [
                    c + "[0]",
            ...
            if ("GET_REMOVE" == b) 
                return c = Blockly
                    .PHP
                    .valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "array()",
                [
                    "array_shift(" + c + ")",
                    Blockly.PHP.ORDER_FUNCTION_CALL
                ];
        ...
        case "FROM_START":
            ...
            if ("GET_REMOVE" == b) 
                return c = Blockly
                    .PHP
                    .valueToCode(a, "VALUE", Blockly.PHP.ORDER_COMMA) || "array()",
                [
        ...
        case "FROM_END":
            ...
            if ("GET_REMOVE" == b || "REMOVE" == b) {
                ...
                d = Blockly
                    .PHP
                    .getAdjusted(a, "AT", 1, !1, Blockly.PHP.ORDER_SUBTRACTION);
        ...
        case "RANDOM":
            ...
            if ("GET" == b) 
                return b = Blockly
                    .PHP
                    .provideFunction_("lists_get_random_item", [
            ...
            if ("GET_REMOVE" == b) 
                return b = Blockly
                    .PHP
                    .provideFunction_("lists_get_remove_random_item", [
                        "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {",
            ...
            if ("REMOVE" == b) 
                return b = Blockly
                    .PHP
                    .provideFunction_("lists_remove_random_item", [
                        "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {",
...
Blockly.PHP.lists_setIndex = function (a) {
    var b = a.getFieldValue("MODE") || "GET",
        ...
        d = Blockly
            .PHP
            .valueToCode(a, "TO", Blockly.PHP.ORDER_ASSIGNMENT) || "null";
    switch (c) {
        case "FIRST":
            if ("SET" == b) 
                return c = Blockly
                    .PHP
                    .valueToCode(a, "LIST", Blockly.PHP.ORDER_MEMBER) || "array()",
                c + "[0] = " + d + ";\n";
            if ("INSERT" == b) 
                return c = Blockly
                    .PHP
                    .valueToCode(a, "LIST", Blockly.PHP.ORDER_COMMA) || "array()",
                "array_unshift(" + c + ", " + d + ");\n";
            break;
        case "LAST":
            c = Blockly
            ...
            if ("SET" == b) 
                return b = Blockly
                    .PHP
                    .provideFunction_("lists_set_last_item", [
        ...
        case "FROM_END":
            ...
            if ("SET" == b) 
                return b = Blockly
                    .PHP
                    .provideFunction_("lists_set_from_end", [
                        "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                                "(&$list, $at, $value) {",
        ...
        case "RANDOM":
            c = Blockly
                .PHP
                .valueToCode(a, "LIST", Blockly.PHP.ORDER_REFERENCE) || "array()";
            c.match(/^\$\w+$/)
                ? a = ""
                : (
                    a = Blockly.PHP.variableDB_.getDistinctName("tmp_list", Blockly.VARIABLE_CATEGORY_NAME),
                    e = a + " = &" + c + ";\n",
                    c = a,
                    a = e
                );
            e = Blockly
                .PHP
                .variableDB_
                .getDistinctName("tmp_x", Blockly.VARIABLE_CATEGORY_NAME);
        ...
        if (b.match(/^\$\w+$/) || "FROM_END" != c && "FROM_START" == d) {
            switch (c) {
                ...
                case "FROM_END":
                    e = Blockly
                        .PHP
                        .getAdjusted(a, "AT1", 1, !1, Blockly.PHP.ORDER_SUBTRACTION);
                    e = "count(" + b + ") - " + e;
                    break;
                case "FIRST":
                    e = "0";
            ...
            switch (d) {
                case "FROM_START":
                    a = Blockly
                        .PHP
                        .getAdjusted(a, "AT2", 0, !1, Blockly.PHP.ORDER_SUBTRACTION);
                    c = a + " - ";
                    c = Blockly.isNumber(String(e)) || String(e).match(/^\(.+\)$/)
                        ? c + e
                        : c + ("(" + e + ")");
                    c += " + 1";
                    break;
            ...
            b = Blockly
                .PHP
                .provideFunction_("lists_get_sublist", [
                    "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($list, $where1, $at1, " +
                            "$where2, $at2) {",
                    "  if ($where1 == 'FROM_END') {",
    ...
    return [
        Blockly
            ...
            .provideFunction_("lists_sort", [
                "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($list, $type, $directi" +
                        "on) {",
                "  $sortCmpFuncs = array(",
...
Blockly.PHP.lists_split = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "INPUT", Blockly.PHP.ORDER_COMMA),
        c = Blockly
            .PHP
            .valueToCode(a, "DELIM", Blockly.PHP.ORDER_COMMA) || "''";
...
Blockly.PHP.controls_if = function (a) {
    ...
    do {
        var d = Blockly
            .PHP
            .valueToCode(a, "IF" + b, Blockly.PHP.ORDER_NONE) || "false";
        var e = Blockly
            .PHP
            .statementToCode(a, "DO" + b);
        Blockly.PHP.STATEMENT_SUFFIX && (
            e = Blockly.PHP.prefixLines(Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a), Blockly.PHP.INDENT) +
                e
        );
        c += (
            0 < b
...
Blockly.PHP.logic_negate = function (a) {
    ...
    return [
        "!" + (
            Blockly.PHP.valueToCode(a, "BOOL", b) || "true"
        ),
        b
    ]
};
...
Blockly.PHP.logic_ternary = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "IF", Blockly.PHP.ORDER_CONDITIONAL) || "false",
        c = Blockly
            .PHP
            .valueToCode(a, "THEN", Blockly.PHP.ORDER_CONDITIONAL) || "null";
    a = Blockly
        .PHP
        .valueToCode(a, "ELSE", Blockly.PHP.ORDER_CONDITIONAL) || "null";
    return [
        b + " ? " + c + " : " + a,
...
Blockly.PHP.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
            ...
            : Blockly
                .PHP
                .valueToCode(a, "TIMES", Blockly.PHP.ORDER_ASSIGNMENT) || "0",
        c = Blockly
            .PHP
    ...
    var d = Blockly
            .PHP
            .variableDB_
            .getDistinctName("count", Blockly.VARIABLE_CATEGORY_NAME),
        e = b;
    b.match(/^\w+$/) || Blockly.isNumber(b) || (
        e = Blockly.PHP.variableDB_.getDistinctName("repeat_end", Blockly.VARIABLE_CATEGORY_NAME),
        a += e + " = " + b + ";\n"
    );
    return a + (
        "for (" + d + " = 0; " + d + " < " + e + "; " + d + "++) {\n" + c + "}\n"
...
Blockly.PHP.controls_for = function (a) {
    var b = Blockly
        ...
        c = Blockly
            .PHP
            .valueToCode(a, "FROM", Blockly.PHP.ORDER_ASSIGNMENT) || "0",
        d = Blockly
            .PHP
            .valueToCode(a, "TO", Blockly.PHP.ORDER_ASSIGNMENT) || "0",
        e = Blockly
            .PHP
            .valueToCode(a, "BY", Blockly.PHP.ORDER_ASSIGNMENT) || "1",
        f = Blockly
            .PHP
            .statementToCode(a, "DO");
    f = Blockly
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
        ...
        d = Blockly
            .PHP
            .variableDB_
            .getDistinctName(b + "_inc", Blockly.VARIABLE_CATEGORY_NAME),
        a += d + " = ",
...
Blockly.PHP.controls_forEach = function (a) {
    var b = Blockly
        ...
        c = Blockly
            .PHP
            .valueToCode(a, "LIST", Blockly.PHP.ORDER_ASSIGNMENT) || "[]",
        d = Blockly
            .PHP
            .statementToCode(a, "DO");
    d = Blockly
...
Blockly.PHP.math_arithmetic = function (a) {
    var b = {
            ...
            MULTIPLY: [
                " * ", Blockly.PHP.ORDER_MULTIPLICATION
            ],
            DIVIDE: [
...
Blockly.PHP.math_single = function (a) {
    ...
    if ("NEG" == b) 
        return a = Blockly
            .PHP
            .valueToCode(a, "NUM", Blockly.PHP.ORDER_UNARY_NEGATION) || "0",
        "-" == a[0] && (a = " " + a),
        [
            "-" + a,
            Blockly.PHP.ORDER_UNARY_NEGATION
    ...
    a = "SIN" == b || "COS" == b || "TAN" == b
        ? Blockly
            .PHP
            .valueToCode(a, "NUM", Blockly.PHP.ORDER_DIVISION) || "0"
        : Blockly
            .PHP
            .valueToCode(a, "NUM", Blockly.PHP.ORDER_NONE) || "0";
    switch (b) {
        case "ABS":
            var c = "abs(" + a + ")";
            break;
...
Blockly.PHP.math_constant = function (a) {
    return {
        PI: [
            "M_PI", Blockly.PHP.ORDER_ATOMIC
        ],
        E: [
            "M_E", Blockly.PHP.ORDER_ATOMIC
        ],
        GOLDEN_RATIO: [
            "(1 + sqrt(5)) / 2", Blockly.PHP.ORDER_DIVISION
        ],
        SQRT2: [
            "M_SQRT2", Blockly.PHP.ORDER_ATOMIC
        ],
        SQRT1_2: [
            "M_SQRT1_2", Blockly.PHP.ORDER_ATOMIC
        ],
...
Blockly.PHP.math_number_property = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "NUMBER_TO_CHECK", Blockly.PHP.ORDER_MODULUS) || "0",
    ...
    switch (c) {
        ...
        case "DIVISIBLE_BY":
            a = Blockly
                .PHP
                .valueToCode(a, "DIVISOR", Blockly.PHP.ORDER_MODULUS) || "0",
            d = b + " % " + a + " == 0"
    }
...
Blockly.PHP.math_change = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "DELTA", Blockly.PHP.ORDER_ADDITION) || "0";
    return Blockly
        .PHP
        .variableDB_
...
Blockly.PHP.math_on_list = function (a) {
    ...
    switch (b) {
        case "SUM":
            a = Blockly
                .PHP
                .valueToCode(a, "LIST", Blockly.PHP.ORDER_FUNCTION_CALL) || "array()";
            a = "array_sum(" + a + ")";
            break;
        case "MIN":
            a = Blockly
        ...
        case "AVERAGE":
            ...
            a = Blockly
                .PHP
                .valueToCode(a, "LIST", Blockly.PHP.ORDER_NONE) || "array()";
            a = b + "(" + a + ")";
            break;
        case "MEDIAN":
            b = Blockly
                .PHP
                .provideFunction_("math_median", [
            ...
            a = Blockly
                .PHP
                .valueToCode(a, "LIST", Blockly.PHP.ORDER_NONE) || "[]";
            a = b + "(" + a + ")";
            break;
        case "MODE":
            b = Blockly
                .PHP
                .provideFunction_("math_modes", [
        ...
        case "STD_DEV":
            b = Blockly
                .PHP
                .provideFunction_("math_standard_deviation", [
        ...
        case "RANDOM":
            b = Blockly
                .PHP
                .provideFunction_("math_random_list", [
                    "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($list) {",
                    "  $x = rand(0, count($list)-1);",
                    "  return $list[$x];",
                    "}"
...
Blockly.PHP.math_modulo = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "DIVIDEND", Blockly.PHP.ORDER_MODULUS) || "0";
    a = Blockly
        .PHP
        .valueToCode(a, "DIVISOR", Blockly.PHP.ORDER_MODULUS) || "0";
    return [
...
Blockly.PHP.math_constrain = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "VALUE", Blockly.PHP.ORDER_COMMA) || "0",
        c = Blockly
            .PHP
            .valueToCode(a, "LOW", Blockly.PHP.ORDER_COMMA) || "0";
    a = Blockly
        .PHP
        .valueToCode(a, "HIGH", Blockly.PHP.ORDER_COMMA) || "Infinity";
    return [
        "min(max(" + b + ", " + c + "), " + a + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
...
Blockly.PHP.math_random_int = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "FROM", Blockly.PHP.ORDER_COMMA) || "0";
    a = Blockly
        .PHP
        .valueToCode(a, "TO", Blockly.PHP.ORDER_COMMA) || "0";
    return [
        Blockly
            .PHP
            .provideFunction_("math_random_int", [
...
Blockly.PHP.math_atan2 = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "X", Blockly.PHP.ORDER_COMMA) || "0";
    return [
        "atan2(" + (
...
Blockly.PHP.procedures_defreturn = function (a) {
    ...
    d = Blockly
        .Variables
        .allDeveloperVariables(d);
    for (f = 0; f < d.length; f++) 
        b.push(
            Blockly.PHP.variableDB_.getName(d[f], Blockly.Names.DEVELOPER_VARIABLE_TYPE)
        );
    b = b.length
        ? Blockly.PHP.INDENT + "global " + b.join(", ") + ";\n"
        : "";
    d = Blockly
        .PHP
        .variableDB_
    ...
    e = "";
    Blockly.PHP.STATEMENT_PREFIX && (
        e += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, a)
    );
    Blockly.PHP.STATEMENT_SUFFIX && (
        e += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a)
    );
    e && (e = Blockly.PHP.prefixLines(e, Blockly.PHP.INDENT));
    c = "";
    Blockly.PHP.INFINITE_LOOP_TRAP && (
        c = Blockly.PHP.prefixLines(Blockly.PHP.injectId(Blockly.PHP.INFINITE_LOOP_TRAP, a), Blockly.PHP.INDENT)
    );
    var g = Blockly
            .PHP
        ...
        h = Blockly
            .PHP
            .valueToCode(a, "RETURN", Blockly.PHP.ORDER_NONE) || "",
        k = "";
    g && h && (k = e);
    ...
    for (f = 0; f < a.arguments_.length; f++) 
        l[f] = Blockly
            .PHP
            .variableDB_
            .getName(a.arguments_[f], Blockly.VARIABLE_CATEGORY_NAME);
    b = "function " + d + "(" + l.join(", ") + ") {\n" + b + e + c + g + k + h +
            "}";
    b = Blockly
        .PHP
...
Blockly.PHP.procedures_callreturn = function (a) {
    for (
        var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("NAME"), Blockly.PROCEDURE_CATEGORY_NAME),
        c = [],
        d = 0;
        ...
        c[d] = Blockly
            .PHP
            .valueToCode(a, "ARG" + d, Blockly.PHP.ORDER_COMMA) || "null";
    return [
        b + "(" + c.join(", ") + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
...
Blockly.PHP.procedures_callnoreturn = function (a) {
    return Blockly
        .PHP
        .procedures_callreturn(a)[0] + ";\n"
};
Blockly.PHP.procedures_ifreturn = function (a) {
    var b = "if (" + (
        Blockly.PHP.valueToCode(a, "CONDITION", Blockly.PHP.ORDER_NONE) || "false"
    ) + ") {\n";
    Blockly.PHP.STATEMENT_SUFFIX && (
        b += Blockly.PHP.prefixLines(Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a), Blockly.PHP.INDENT)
    );
    a.hasReturnValue_
        ? (
            a = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "null",
...
Blockly.PHP.text_multiline = function (a) {
    return [
        Blockly
            .PHP
            .multiline_quote_(a.getFieldValue("TEXT")),
        Blockly.PHP.ORDER_ATOMIC
    ]
};
Blockly.PHP.text_join = function (a) {
    ...
    if (1 == a.itemCount_) 
        return [
            Blockly
                .PHP
                .valueToCode(a, "ADD0", Blockly.PHP.ORDER_NONE) || "''",
            Blockly.PHP.ORDER_FUNCTION_CALL
        ];
    if (2 == a.itemCount_) {
        var b = Blockly
            .PHP
            .valueToCode(a, "ADD0", Blockly.PHP.ORDER_ATOMIC) || "''";
        a = Blockly
            .PHP
            .valueToCode(a, "ADD1", Blockly.PHP.ORDER_ATOMIC) || "''";
        return [
            b + " . " + a,
    ...
    for (var c = 0; c < a.itemCount_; c++) 
        b[c] = Blockly
            .PHP
            .valueToCode(a, "ADD" + c, Blockly.PHP.ORDER_COMMA) || "''";
...
Blockly.PHP.text_append = function (a) {
    ...
    a = Blockly
        .PHP
        .valueToCode(a, "TEXT", Blockly.PHP.ORDER_ASSIGNMENT) || "''";
    return b + " .= " + a + ";\n"
};
...
Blockly.PHP.text_getSubstring = function (a) {
    var b = Blockly
            .PHP
            .valueToCode(a, "STRING", Blockly.PHP.ORDER_FUNCTION_CALL) || "''",
        c = a.getFieldValue("WHERE1"),
        d = a.getFieldValue("WHERE2");
    if ("FIRST" != c || "LAST" != d) {
        var e = Blockly
        ...
        b = Blockly
            .PHP
            .provideFunction_("text_get_substring", [
                "function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($text, $where1, $at1, " +
                        "$where2, $at2) {",
                "  if ($where1 == 'FROM_END') {",
...
Blockly.PHP.text_changeCase = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "TEXT", Blockly.PHP.ORDER_NONE) || "''";
    if ("UPPERCASE" == a.getFieldValue("CASE")) 
        var c = "strtoupper(" + b + ")";
    else 
...
Blockly.PHP.text_count = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "TEXT", Blockly.PHP.ORDER_MEMBER) || "''";
    a = Blockly
        .PHP
        .valueToCode(a, "SUB", Blockly.PHP.ORDER_NONE) || "''";
    return [
        "strlen(" + a + ") === 0 ? strlen(" + b + ") + 1 : substr_count(" + b + ", " + a +
                ")",
        Blockly.PHP.ORDER_CONDITIONAL
    ]
};
Blockly.PHP.text_replace = function (a) {
    var b = Blockly
        ...
        c = Blockly
            .PHP
            .valueToCode(a, "FROM", Blockly.PHP.ORDER_NONE) || "''";
    a = Blockly
        .PHP
        .valueToCode(a, "TO", Blockly.PHP.ORDER_NONE) || "''";
    return [
        "str_replace(" + c + ", " + a + ", " + b + ")",
        Blockly.PHP.ORDER_FUNCTION_CALL
    ]
...
Blockly.PHP.variables_set = function (a) {
    var b = Blockly
        .PHP
        .valueToCode(a, "VALUE", Blockly.PHP.ORDER_ASSIGNMENT) || "0";
    return Blockly
        .PHP
        .variableDB_
        .getName(a.getFieldValue("VAR"), Blockly.VARIABLE_CATEGORY_NAME) + " = " + b +
